...
THEME_MAP = {
    ...
    "death":        ["death","die","soul","eternal","rebirth","reincarnation","mrityu","aatma","atma","parmatma","paramatma","jivatma","spirit","consciousness"],
    "devotion":     ["devotion","bhakti","worship","prayer","love for krishna","bhajan","pooja","chant","chanting","mantra","hare krishna"],
    "detachment":   ["attachment","detachment","letting go","vairagya","material","moh","desires","possessive"],
    "maya":         ["maya","illusion","material world","temporary","sansaar","duniya","unreal","reality"],
    "meditation":   ["meditation","mind","yoga","focus","concentration","dhyan","mann","peace","calm","stillness"],
    "surrender":    ["surrender","give to god","sharanagati","accept","samarpan","trust god","let go"],
