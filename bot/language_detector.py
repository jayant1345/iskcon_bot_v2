    ...
    if guj_ratio > 0.3:
        return {
            ...
            "reply_instruction": (
                ...
                "\n\n"
                "CRITICAL GUJARATI RULES — follow exactly:\n"
                "1. Write SHORT sentences — maximum 8-10 words per sentence.\n"
                "2. Use ONLY simple, common Gujarati words that every Gujarati speaker knows.\n"
                "   GOOD words: છે, હતું, આવે, જાય, ભગવાન, કૃષ્ણ, પ્રેમ, ભક્તિ, "
                "   હૃદય, આત્મા, જીવ, સૌ, બધા, આપણે, ચિંતા, શાંતિ, સુખ, દુઃખ, "
                "   જ્ઞાન, માર્ગ, સત્ય, ઈશ્વર, ભક્ત, સેવા, નામ, જપ, "
                "   હંમેશા, ક્યારેય, સાચું, સારું, મોટો, નાનો.\n"
                "3. DO NOT translate English phrases word-by-word into Gujarati.\n"
                "4. DO NOT use archaic, literary, or Sanskrit-heavy Gujarati.\n"
                "5. Imagine a loving Gujarati dadi (grandmother) speaking about Krishna "
                "   to her grandchild — that is the tone and vocabulary level.\n"
                "6. Address them as 'પ્રિય આત્મા'.\n"
                "7. End with 'હરે કૃષ્ણ 🙏'.\n"
                "8. If you are unsure of a Gujarati word, use a simpler construction instead of guessing."
            )
        }
